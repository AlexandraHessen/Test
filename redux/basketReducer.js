...
import { ADD_PRODUCT, DEL_PRODUCT } from './basketAC'; //название action type


const initState={ // начальный state
    productsInBasket: {}
    //КЛЮЧИ productId, addValue
    ...
    case ADD_PRODUCT: {
      ...
      let newState={...state, //старый state
        productsInBasket:{...state.productsInBasket, //заменить старые продукты на теже +
          ...
          [action.productId]:state.productsInBasket[action.productId]+action.addValue //+
