...
*** 
При добавление товара в корзину вкладка автоматически переключается на вкладку корзины. Есть валидация формы которая при введении значения, автоматически отображает сообщение об ошибке, если форма не валидна кнопка “Оформить заказ” запрещена
